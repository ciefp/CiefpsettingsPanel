...
PLUGINS = {
    ...
    "CiefpVideoPlayer": "wget -q --no-check-certificate https://raw.githubusercontent.com/ciefp/CiefpVideoPlayer/main/installer.sh -O - | /bin/sh",
    ...
    "MagicPanel": "wget -q --no-check-certificate https://raw.githubusercontent.com/Ham-ahmed/pro/refs/heads/main/MagicPanelPro-v6.5_install.sh -O - | /bin/sh",
    ...
    "Ultra Stalker": "wget -qO- https://raw.githubusercontent.com/K3bOra/-UltraStalker/main/install.sh |/bin/sh",
    "TiviMate": "wget -qO- https://raw.githubusercontent.com/opesboy/TiviMateE2/main/install.sh | sh",
    ...
    "############ ( Sport Plugins ) ############": "", 
    "SimplySports": "cd /usr/lib/enigma2/python/Plugins/Extensions && rm -rf SimplySports && wget --no-check-certificate https://github.com/Ahmed-Mohammed-Abbas/SimplySports/archive/refs/heads/main.zip -O SimplySports.zip && unzip SimplySports.zip && mv SimplySports-main SimplySports && rm SimplySports.zip && killall -9 enigma2",
    ...
    "Ncam 13": "wget https://raw.githubusercontent.com/emilnabil/ncam/main/installer.sh -O - | /bin/sh",
    "Oscam-emu": "wget https://raw.githubusercontent.com/emilnabil/oscam/main/installer.sh -O - | /bin/sh",
    ...
    "Streamlink": "opkg install streamlink",
