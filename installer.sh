#!/bin/bash
##setup command=wget -q "--no-check-certificate" https://raw.githubusercontent.com/ciefp/CiefpsettingPanel/main/installer.sh -O - | /bin/sh
...
if [ -f /var/lib/dpkg/status ]; then
   ...
   wget https://github.com/ciefp/CiefpsettingsPanel/archive/refs/heads/main.tar.gz
   tar -xzf main.tar.gz
   cp -r 'CiefpsettingsPanel-main/usr' '/'
set +e
cd
sleep 2
